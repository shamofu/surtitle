...
Function PageReinstall
  ...
  surtitle_nsis_utils::SemverCompare "${VERSION}" $R0
  Pop $R0
...
Function RunMainBinary
  surtitle_nsis_utils::RunAsUser "$INSTDIR\${MAINBINARYNAME}.exe" ""
FunctionEnd
...
Function .onInstSuccess
  ...
  ${OrIf} ${Silent}
    ...
    ${IfNot} ${Errors}
      ...
      surtitle_nsis_utils::RunAsUser "$INSTDIR\${MAINBINARYNAME}.exe" "$R0"
    ${EndIf}
  ${EndIf}
FunctionEnd
